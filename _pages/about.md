...
---
I build **medical language models that are reliable enough to deploy** — auditable against clinical guidelines, evaluated for why they fail rather than just whether they pass, and efficient enough to adapt to a clinical domain within an academia-level compute budget. My research focus over the last six years and 16+ peer-reviewed papers (SIGIR, ACL, IJCAI, EMNLP, ECAI, CIKM) has been to bridge the gap between medical AI that works in a paper and medical AI that a hospital can actually adopt, i.e., translating a Proof-of-concept to bedside.
...
![Research map: efficient medical foundation models, reliability evaluation on real-world data, and guideline-grounded clinical reasoning converging on deployable clinical AI, grounded in real-world data, across academia and industry.](research_map.png)
